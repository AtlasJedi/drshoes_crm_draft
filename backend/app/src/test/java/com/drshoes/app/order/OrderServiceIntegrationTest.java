...
class OrderServiceIntegrationTest extends AbstractIntegrationTest {
    ...
    void list_excludesSoftDeleted() {
        ...
        Page<OrderListRow> page = svc.list(null, null, null, null, null, null, null, null, PageRequest.of(0, 20));
    ...
    void listFiltersByStatus() {
        ...
        Page<OrderListRow> page = svc.list(List.of(OrderStatus.PRZYJETE), null, null, null, null, null, null, null, PageRequest.of(0, 20));
    ...
    void listSearchesByQuery() {
        ...
        Page<OrderListRow> page = svc.list(null, null, null, "czyszczenie", null, null, null, null, PageRequest.of(0, 20));
