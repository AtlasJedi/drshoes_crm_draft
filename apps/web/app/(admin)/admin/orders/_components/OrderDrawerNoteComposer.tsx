...
// LOC note: ~110 lines — single-purpose component, accepted over 80-LOC guideline per task 10-10.
"use client";
  ...
  return (
    <section className="mt-4 pt-4" style={{ borderTop: "2px dashed var(--ink)" }}>
      <button
        ...
        aria-expanded={open}
        onClick={() => setOpen((o) => !o)}
        className="t-mono w-full text-left flex items-center justify-between"
        style={{ fontSize: 11, letterSpacing: ".08em", textTransform: "uppercase", color: "var(--admin-mute)", background: "none", border: "none", cursor: "pointer", padding: 0 }}
      >
        <span>Dodaj wpis do historii</span>
